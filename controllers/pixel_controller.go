...
// RenderHome affiche la page HTML
...
// GetProxyState récupère l'état depuis le serveur distant
...
// SubmitProxyGrid enregistre localement PUIS envoie au serveur distant
func SubmitProxyGrid(c *gin.Context) {
	...
	// 2. Logique BDD : Sauvegarde locale de l'historique
	...
	// 4. Retourne la réponse du serveur distant au client JS
	c.Data(status, "application/json", remoteBody)
}

// GetLocalHistory (Nouvelle route !) permet de voir ce qu'on a envoyé
